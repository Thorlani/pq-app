...
const Contract = () => {
  ...
  return (
    <>
      <Helmet>
        <ReactSeo
          title="Law of Contract questions"
          description="This is the list of answered law of contract questions that Belovedthorlani offers for free."
          ...
          canonicalUrl="https://www.belovedthorlani.com.ng/contract"
          meta={[
            { name: "keywords", content: "law of contract, offer, acceptance,privity of contract, consideration" },
