...
const LegalRead = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://be-law-pq.vercel.app/api/getLegal/${id}`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
    ...
    <>
      <Helmet>
        <ReactSeo
          ...
          description={`This is the answer to the legal system question ${data.question}`}
          ...
          meta={[
            { name: "keywords", content: `legal systems, ${data.question}, ${data.answer}` },
