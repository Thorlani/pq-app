...
const Legal = () => {
  ...
  return (
    <>
      <Helmet>
        <ReactSeo
          title="Legal system questions"
          description="This is the list of answered legal system questions that Belovedthorlani offers for free."
          ...
          canonicalUrl="https://www.belovedthorlani.com.ng/legal"
          meta={[
            { name: "keywords", content: "legal system, Common law, Equity" },
