  ...
  return (
    ...
    <Helmet>
        <ReactSeo
          ...
          description="This is the privacy policy page of Belovedthorlani website."
          ...
          canonicalUrl="https://www.belovedthorlani.com.ng/privacy"
          meta={[
            { name: "keywords", content: "Belovedthorlani, privacy" },
