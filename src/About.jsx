...
const About = () => {
  return (
    ...
    <Helmet>
        <ReactSeo
          title="About Us"
          description="This is the about page of Belovedthorlani website."
          ...
          canonicalUrl="https://www.belovedthorlani.com.ng/about"
          meta={[
            { name: "keywords", content: "Belovedthorlani, about us" },
