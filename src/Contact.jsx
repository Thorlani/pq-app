  ...
  return (
    <>
      <Helmet>
        <ReactSeo
          title="Contact Us"
          description="This is the contact page of Belovedthorlani website."
          ...
          canonicalUrl="https://www.belovedthorlani.com.ng/contact"
          meta={[
            { name: "keywords", content: "Belovedthorlani, contact us" },
